...
Defined in: [packages/@divvi/mobile/src/viem/prepareTransactions.ts:64](https://github.com/divvixyz/divvi-mobile/blob/main/packages/@divvi/mobile/src/viem/prepareTransactions.ts#L64)
