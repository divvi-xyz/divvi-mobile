...
describe('DappsScreen', () => {
  ...
  describe('favorite dapps', () => {
    ...
    it('triggers the events when favoriting', () => {
      ...
      const allDappsSection = getByTestId('DappsScreen/DappsList')
  ...
  describe('searching dapps', () => {
    it('renders correctly when there are no search results', () => {
      ...
      expect(getByTestId('DappsScreen/AllSection/NoResults')).toBeTruthy()
    })
    ...
    it('renders correctly when there are search results in both sections', () => {
      ...
      expect(queryByTestId('DappsScreen/FavoritesSection/NoResults')).toBeNull()
      expect(queryByTestId('DappsScreen/AllSection/NoResults')).toBeNull()
    })
  ...
  describe('filter dapps', () => {
    ...
    it('triggers event when clearing filters from favorite section', () => {
      ...
      expect(queryByTestId('DappsScreen/FavoritesSection/Title')).toBeNull()
      expect(queryByTestId('DappsScreen/FavoritesSection/DappCard')).toBeNull()
