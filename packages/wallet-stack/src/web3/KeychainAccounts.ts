...
export async function getStoredPrivateKey(
  ...
  // There was a bug introduced in https://github.com/valora-xyz/wallet/blob/f7b3a2cc7c2689a17b7eb50edfdb1b8743f441d1/src/web3/KeychainAccountManager.ts#L63-L71
