/**
 * With the current structure of the wallet-stack package there is a requirement to initialize
 ...
 * The same issue happens if we try to use absolute imports like 'wallet-stack/src/redux/hooks'.
 *
