...
An `.env` example is present at `apps/example/e2e/.env` rename this file to `.env` and populate the secrets from Google Cloud Platform. Do not commit the newly created `apps/example/e2e/.env` file.
